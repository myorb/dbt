...
describe('Jobs Endpoints', () => {
    ...
    it('should not deposit money into the balance of a client', async () => {
        ...
        expect(res.body.message).toBe("Cannot deposit more than 25% your total of jobs to pay")
    })
...
describe('Admin Endpoints', () => {
    it('should return the best profession', async () => {
        const res = await request(app)
            .get('/admin/best-profession?start=2020-08-14T23:11:26.737Z&end=2050-01-13')
    ...
    it('should return the best clients', async () => {
        const res = await request(app)
            .get('/admin/best-clients?start=2020-08-14T23:11:26.737Z&end=2050-01-13&limit=2')
            .set('profile_id', 'admin')
        expect(res.statusCode).toEqual(200)
